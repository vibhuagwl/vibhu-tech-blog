...
/**
 * Strangler Fig router — gradually shifts traffic from legacy to new implementation.
 * Maps to curriculum Part 01 (Strangler Fig) and Part 02 (Gateway routing).
 */
public final class StranglerRouter<T, R> {
    ...
    public StranglerRouter(int newServicePercent, Function<T, R> legacyHandler, Function<T, R> newHandler) {
