...
/**
 * Choreography-style saga — each handler reacts to events and publishes the next.
 * Maps to curriculum Part 06 (Choreography vs Orchestration).
 */
public final class ChoreographyHandlers {

    public sealed interface SagaEvent permits OrderCreated, PaymentReserved, PaymentFailed, InventoryReserved {
        String orderId();
    }
