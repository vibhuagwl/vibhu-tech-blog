...
/**
 * Anti-Corruption Layer — translates legacy monolith models into the new domain vocabulary. Maps to
 * curriculum Part 01 (ACL / branch-by-abstraction).
 */
public final class AntiCorruptionLayer {
  ...
  public record OrderPlaced(
      String orderId, CustomerRef customer, Money total, OrderStatus status, Instant placedAt) {}
