...
public class AuditServiceClient {
    ...
    public void recordPiiAccess(String actor, UUID customerId, boolean fullPiiGranted, String clientIp) {
        PiiAccessEventRequest event = new PiiAccessEventRequest(
                Instant.now(),
                actor,
                "support-api",
                "READ_CUSTOMER",
