...
public class SupportCustomerService {
    ...
    public SupportCustomerService(CustomerServiceClient customerClient, AuditServiceClient auditClient) {
    ...
    public CustomerView create(CreateCustomerRequest request) {
        ...
        log.info("Support created customer id={} actor={}",
                created.id(), currentUsername());
    ...
    public CustomerView get(UUID id, boolean fullPii, HttpServletRequest httpRequest) {
        ...
        auditClient.recordPiiAccess(
                currentUsername(),
                id,
                fullPii,
                clientIp(httpRequest));

        log.info("Support read customer id={} masked={} actor={}",
                id, mask, SecretSanitizer.redact(currentUsername()));
