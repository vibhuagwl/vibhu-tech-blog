...
public class HomeController {
    ...
    @GetMapping("/payments")
    public String payments(@RegisteredOAuth2AuthorizedClient("idanywhere") OAuth2AuthorizedClient client,
    ...
    public String tokenDebug(@RegisteredOAuth2AuthorizedClient("idanywhere") OAuth2AuthorizedClient client,
            Model model) {
    ...
    private static String preview(String jwt) {
        if (jwt == null || jwt.length() < 24) {
            return Map.of("len", jwt == null ? 0 : jwt.length())
                    .toString();
        }
