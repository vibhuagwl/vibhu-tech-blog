    ...
    <main className="mx-auto max-w-[1400px] px-5 py-10">
      <header className="max-w-3xl">
        ...
        <div className="mt-5 flex flex-wrap gap-3 text-sm">
          ...
          <a href="#types" className="font-semibold text-slate-700 hover:underline dark:text-blue-400">
            Types →
          </a>
          <span className="text-slate-300">·</span>
          ...
          <span className="text-slate-300">·</span>
          <a href="#ddos-source" className="font-semibold text-slate-700 hover:underline dark:text-blue-400">
            Source →
          </a>
          <span className="text-slate-300">·</span>
