  ...
  return (
    <main className="mx-auto max-w-7xl px-5 py-14">
      <div className="max-w-3xl">
        ...
        <p className="mt-5 text-lg leading-8 text-slate-600">Senior interviews probe failure, scale, consistency and trade-offs. Use these questions after each design.</p>
      </div>
      ...
      {prep && (
        <section className="mt-10">
          <Link href={`/system-design/${prep.slug}`} className="card block p-6 transition hover:-translate-y-0.5 md:p-8">
            ...
            <h2 className="mt-3 text-2xl font-black tracking-tight md:text-3xl">{prep.title}</h2>
            <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-500 md:text-base">{prep.description}</p>
