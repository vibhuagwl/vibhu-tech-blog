...
const DEMO_ROOT=path.join(process.cwd(),'spring-whatsapp-demo');
...
export function listSpringWhatsappDemoFiles():DemoSourceFile[]{
...
export function buildSpringWhatsappDemoTree(files:DemoSourceFile[]):DemoTreeNode[]{
