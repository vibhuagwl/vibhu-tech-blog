...
const DEMO_ROOT=path.join(process.cwd(),'idanywhere-oidc-demo');
...
export function listIdAnywhereDemoFiles():DemoSourceFile[]{
...
export function buildIdAnywhereDemoTree(files:DemoSourceFile[]):DemoTreeNode[]{
