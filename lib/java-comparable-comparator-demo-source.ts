...
const DEMO_ROOT = path.join(process.cwd(), 'java-comparable-comparator-demo');

const INCLUDE_EXT = new Set(['.java', '.md', '.txt', '.properties']);

const SKIP_DIR = new Set(['out', '.git', 'node_modules']);
...
export function listJavaComparableComparatorDemoFiles(): DemoSourceFile[] {
...
export function buildJavaComparableComparatorDemoTree(files: DemoSourceFile[]): DemoTreeNode[] {
