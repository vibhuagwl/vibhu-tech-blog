...
const DEMO_ROOT = path.join(process.cwd(), 'spring-bloom-filter-lab');
...
export function listSpringBloomFilterLabFiles(): DemoSourceFile[] {
...
export function buildSpringBloomFilterLabTree(files: DemoSourceFile[]): DemoTreeNode[] {
