...
const DEMO_ROOT=path.join(process.cwd(),'spring-msp-platform');
...
export function listSpringMspPlatformFiles():DemoSourceFile[]{
...
export function buildSpringMspPlatformTree(files:DemoSourceFile[]):DemoTreeNode[]{
