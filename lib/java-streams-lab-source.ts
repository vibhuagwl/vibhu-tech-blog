...
const DEMO_ROOT = path.join(process.cwd(), 'java-streams-lab');
...
export function listJavaStreamsLabFiles(): DemoSourceFile[] {
...
export function buildJavaStreamsLabTree(files: DemoSourceFile[]): DemoTreeNode[] {
