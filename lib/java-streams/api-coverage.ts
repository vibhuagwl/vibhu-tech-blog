...
export const API_COVERAGE: ApiCoverageRow[] = [
  ...
  {api: 'Collectors.toCollection()', group: 'Collectors', since: '8', problemIds: ['api30', 'c01'], flags: yes()},
  {api: 'Collectors.toMap()', group: 'Collectors', since: '8', problemIds: ['tj02'], flags: yes()},
  ...
  {api: 'Collectors.joining()', group: 'Collectors', since: '8', problemIds: ['tj01'], flags: yes()},
  {api: 'Collectors.counting()', group: 'Collectors', since: '8', problemIds: ['g01'], flags: yes()},
  {api: 'Collectors.summarizingInt()', group: 'Collectors', since: '8', problemIds: ['c02'], flags: yes()},
  {api: 'Collectors.summarizingLong()', group: 'Collectors', since: '8', problemIds: ['api24'], flags: yes()},
  {api: 'Collectors.summarizingDouble()', group: 'Collectors', since: '8', problemIds: ['api24'], flags: yes()},
  {api: 'Collectors.summingInt/Long/Double()', group: 'Collectors', since: '8', problemIds: ['c03'], flags: yes()},
  {api: 'Collectors.averagingInt/Long/Double()', group: 'Collectors', since: '8', problemIds: ['c04'], flags: yes()},
  {api: 'Collectors.groupingBy()', group: 'Collectors', since: '8', problemIds: ['g01'], flags: yes()},
  {api: 'Collectors.groupingByConcurrent()', group: 'Collectors', since: '8', problemIds: ['g09', 'pr02'], flags: yes()},
  {api: 'Collectors.partitioningBy()', group: 'Collectors', since: '8', problemIds: ['p01'], flags: yes()},
  {api: 'Collectors.mapping()', group: 'Collectors', since: '8', problemIds: ['g03'], flags: yes()},
  {api: 'Collectors.filtering()', group: 'Collectors', since: '9', problemIds: ['api30'], flags: yes()},
  {api: 'Collectors.flatMapping()', group: 'Collectors', since: '9', problemIds: ['api30'], flags: yes()},
  {api: 'Collectors.collectingAndThen()', group: 'Collectors', since: '8', problemIds: ['ac01'], flags: yes()},
  {api: 'Collectors.minBy() / maxBy()', group: 'Collectors', since: '8', problemIds: ['g04'], flags: yes()},
  {api: 'Collectors.reducing()', group: 'Collectors', since: '8', problemIds: ['api25'], flags: yes()},
  {api: 'Collectors.teeing()', group: 'Collectors', since: '12', problemIds: ['ac02'], flags: yes()},
