...
export const PROBLEM_GROUPS: ProblemGroup[] = [
  ...
  {id:'strings', title:'String streams', lead:'Complete flavours: chars/codePoints, splitAsStream, joining, anagrams, first-unique, Unicode traps.', problems: byCat('strings')},
  {id:'arrays-lists', title:'Arrays · Two lists', lead:'Complete flavours: Arrays.stream traps, set ops, zip/intersect/union, primitive arrays.', problems: byCat('arrays-lists')},
  {id:'maps', title:'Map streams', lead:'Complete flavours: entrySet sort/filter/transform, merge, invert, ConcurrentMap rules.', problems: byCat('maps')},
  {id:'employee', title:'Employee suite', lead:'Complete HR pipeline flavours: dept aggregates, top-N/per-dept, partition, skills flatMap.', problems: byCat('employee')},
  {id:'ecommerce', title:'E-commerce', lead:'Complete nested flatMap flavours: revenue, SKU totals, paid filters, top products.', problems: byCat('ecommerce')},
  {id:'fintech', title:'FinTech / payments', lead:'Complete ledger flavours: BigDecimal totals, FX, idempotency keys, success rates, windows.', problems: byCat('fintech')},
  {id:'datetime-optional', title:'DateTime · Optional', lead:'Complete flavours: Optional.stream/ofNullable, YearMonth buckets, windows, orElse traps.', problems: byCat('datetime-optional')},
  ...
  {id:'production', title:'Production · JPA · files', lead:'Complete production flavours: Files.lines close, JPA streams, exceptions, determinism, scale.', problems: byCat('production')},
  {id:'api-coverage', title:'API coverage matrix programs', lead:'Less-common Stream / primitive / Collector APIs — systematic coverage matrix.', problems: byCat('api-coverage')},
];
