...
const DEMO_ROOT = path.join(process.cwd(), 'spring-cache-lab');
...
export function listSpringCacheLabFiles(): DemoSourceFile[] {
...
export function buildSpringCacheLabTree(files: DemoSourceFile[]): DemoTreeNode[] {
