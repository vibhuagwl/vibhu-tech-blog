...
const DEMO_ROOT = path.join(process.cwd(), 'spring-multitenant-lab');
...
export function listSpringMultitenantLabFiles(): DemoSourceFile[] {
...
export function buildSpringMultitenantLabTree(files: DemoSourceFile[]): DemoTreeNode[] {
