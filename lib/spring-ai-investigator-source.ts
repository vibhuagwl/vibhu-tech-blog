...
const DEMO_ROOT = path.join(process.cwd(), 'spring-ai-payment-investigator');
...
const SKIP_DIR = new Set(['target', '.git', 'node_modules', '.idea', '.mvn']);
...
export function listSpringAiInvestigatorFiles(): DemoSourceFile[] {
...
export function buildSpringAiInvestigatorTree(files: DemoSourceFile[]): DemoTreeNode[] {
