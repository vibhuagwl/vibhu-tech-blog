...
const DEMO_ROOT=path.join(process.cwd(),'spring-web-attacks-demo');
...
export function listSpringWebAttacksDemoFiles():DemoSourceFile[]{
...
export function buildSpringWebAttacksDemoTree(files:DemoSourceFile[]):DemoTreeNode[]{
