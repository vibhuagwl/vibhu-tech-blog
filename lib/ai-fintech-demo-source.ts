...
const DEMO_ROOT = path.join(process.cwd(), 'ai-fintech-platform');
...
export function listAiFintechDemoFiles(): DemoSourceFile[] {
...
export function buildAiFintechDemoTree(files: DemoSourceFile[]): DemoTreeNode[] {
