...
const DEMO_ROOT=path.join(process.cwd(),'spring-csrf-demo');
...
export function listSpringCsrfDemoFiles():DemoSourceFile[]{
...
export function buildSpringCsrfDemoTree(files:DemoSourceFile[]):DemoTreeNode[]{
