...
const DEMO_ROOT = path.join(process.cwd(), 'spring-rate-limiter-lab');

const INCLUDE_EXT = new Set([
  '.java', '.xml', '.yml', '.yaml', '.sql', '.md', '.html', '.sh', '.json', '.properties', '.txt', '.css', '.lua',
]);
...
export function listSpringRateLimiterLabFiles(): DemoSourceFile[] {
...
export function buildSpringRateLimiterLabTree(files: DemoSourceFile[]): DemoTreeNode[] {
