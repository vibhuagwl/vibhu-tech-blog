...
const DEMO_ROOT=path.join(process.cwd(),'spring-kafka-payments-demo');
...
export function listSpringKafkaPaymentsDemoFiles():DemoSourceFile[]{
...
export function buildSpringKafkaPaymentsDemoTree(files:DemoSourceFile[]):DemoTreeNode[]{
