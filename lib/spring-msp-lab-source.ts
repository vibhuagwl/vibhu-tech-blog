...
const DEMO_ROOT=path.join(process.cwd(),'spring-microservices-patterns-lab');
...
export function listSpringMspLabFiles():DemoSourceFile[]{
...
export function buildSpringMspLabTree(files:DemoSourceFile[]):DemoTreeNode[]{
