...
const DEMO_ROOT = path.join(process.cwd(), 'spring-encryption-lab');
...
export function listSpringEncryptionLabFiles(): DemoSourceFile[] {
...
export function buildSpringEncryptionLabTree(files: DemoSourceFile[]): DemoTreeNode[] {
