...
const DEMO_ROOT = path.join(process.cwd(), 'financial-ai-platform');
...
export function listSpringAiDemoFiles(): DemoSourceFile[] {
...
export function buildSpringAiDemoTree(files: DemoSourceFile[]): DemoTreeNode[] {
