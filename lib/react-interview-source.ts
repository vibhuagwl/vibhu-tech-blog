...
const DEMO_ROOT = path.join(process.cwd(), 'react-springboot-interview');
...
export function listReactInterviewLabFiles(): DemoSourceFile[] {
...
export function buildReactInterviewLabTree(files: DemoSourceFile[]): DemoTreeNode[] {
