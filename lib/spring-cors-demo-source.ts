...
const DEMO_ROOT=path.join(process.cwd(),'spring-cors-demo');
...
export function listSpringCorsDemoFiles():DemoSourceFile[]{
...
export function buildSpringCorsDemoTree(files:DemoSourceFile[]):DemoTreeNode[]{
