...
public class ClientCredentialsOAuthTokenProvider implements KafkaOAuthTokenProvider {
    ...
    public ClientCredentialsOAuthTokenProvider(RestClient restClient, String tokenEndpoint, String clientId,
    ...
    public String getAccessToken() {
        ...
        if (current != null && current.expiresAt.minusSeconds(SKEW_SECONDS)
                .isAfter(Instant.now())) {
        ...
        synchronized (lock) {
            ...
            Instant expiresAt = Instant.now()
                    .plusSeconds(response.expiresIn() > 0 ? response.expiresIn() : 60);
    ...
    public record TokenResponse(@JsonProperty("access_token") String accessToken,
                                ...
                                @JsonProperty("token_type") String tokenType, @JsonProperty("scope") String scope) {
    }
