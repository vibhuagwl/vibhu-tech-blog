...
import type {HubSection} from '@/lib/technology-hub';
    ...
    <div>
      <header className="rounded-2xl border border-slate-200 bg-white p-6 md:p-10 dark:border-slate-800 dark:bg-slate-950">
        ...
        <p className="mt-4 text-sm font-semibold text-slate-700 dark:text-slate-200">
          Learn → Experience → Optimize → Configure → Troubleshoot → Upgrade → Interview → Recall
        </p>
      ...
      <section className="mt-10">
        <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Learning map</h2>
        <p className="mt-2 text-slate-500">
          Do not open a giant topic dump. Choose the mode you need, then drill down.
        </p>
