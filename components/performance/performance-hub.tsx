    ...
    <div className="mx-auto max-w-[1400px] px-5 py-10">
      <header className="max-w-4xl">
        ...
        <p className="mt-4 text-lg leading-8 text-slate-600 dark:text-slate-300">
          One handbook for diagnosing Java / Spring / database / Kafka / AWS latency — not a tip dump.
      ...
      <div className="mt-10 grid gap-10 xl:grid-cols-[260px_minmax(0,1fr)]">
        ...
        <div className="min-w-0 space-y-16">
          ...
          <Section id="virtual-threads" title="06. Virtual threads" lead="Concurrency capacity ≠ faster database.">
