...
public class DeliveryAttemptRepository {
    private final ConcurrentMap<String, CopyOnWriteArrayList<DeliveryAttemptRecord>> attemptsByMessageId =
    ...
    public DeliveryAttemptRecord record(
        ...
        DeliveryAttemptRecord attempt = new DeliveryAttemptRecord(
                serverMsgId,
                recipientId,
                deviceId,
                gatewayNode,
        ...
        attemptsByMessageId.computeIfAbsent(serverMsgId, ignored -> new CopyOnWriteArrayList<>()).add(attempt);
        return attempt;
    }
