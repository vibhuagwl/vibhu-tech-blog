...
public class LocalDeliveryCoordinator {
  ...
  private final ConcurrentMap<String, CopyOnWriteArrayList<MessageCreatedEvent>>
      pendingByRecipient = new ConcurrentHashMap<>();

  public LocalDeliveryCoordinator(
      PresenceStore presenceStore, DeliveryAttemptRepository deliveryAttemptRepository) {
