...
public class MessageRepository {
    ...
    private final ConcurrentMap<String, CopyOnWriteArrayList<String>> messageIdsByConversation = new ConcurrentHashMap<>();
    private final ConcurrentMap<String, AtomicLong> serverSeqByConversation = new ConcurrentHashMap<>();
    private final ConcurrentMap<IdempotencyKey, String> serverMsgIdByIdempotencyKey = new ConcurrentHashMap<>();
    ...
    public synchronized MessagePersistResult saveIfAbsent(
        ...
        long serverSeq = serverSeqByConversation
    ...
    public List<MessageRecord> findConversationMessagesAfter(String conversationId, long afterSeq) {
        return messageIdsByConversation.getOrDefault(conversationId, new CopyOnWriteArrayList<>()).stream()
