...
public class WorkerDeliveryAttemptRepository {
    private final ConcurrentMap<String, CopyOnWriteArrayList<WorkerDeliveryAttempt>> attemptsByMessageId =
    ...
    public WorkerDeliveryAttempt record(
        ...
        WorkerDeliveryAttempt attempt = new WorkerDeliveryAttempt(
                serverMsgId,
                recipientId,
                deviceId,
                gatewayNode,
