...
class PaymentDecoratorDemoTest {
    @Test void shouldAddBehaviorWithoutChangingCoreProcessor() {
        ...
        var processor = new PaymentDecoratorDemo.LoggingDecorator(
                new PaymentDecoratorDemo.MetricsDecorator(new PaymentDecoratorDemo.BasicPayment(), metrics), audit);
    ...
    @Test void shouldRetryTransientFailure() {
