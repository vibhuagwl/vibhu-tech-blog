...
public class PaymentValidationChainDemo {
    ...
    public static void run() {
        ...
        System.out.println("PROBLEM: One mega validatePayment() method chains auth, amount, fraud, and account checks" + " in nested if-else, making reordering or adding validators risky.");
        System.out.println("SOLUTION: Linked Validator handlers each check one concern; validate() walks the chain and" + " short-circuits on the first failure.");
