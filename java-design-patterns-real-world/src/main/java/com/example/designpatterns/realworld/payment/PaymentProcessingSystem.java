...
public class PaymentProcessingSystem {
  ...
  public static final class AuthenticationValidator implements Validator {
    public ValidationResult validate(PaymentRequest request) {
      return request.customerId().isBlank()
          ? ValidationResult.fail("auth")
  ...
  public static final class AmountValidator implements Validator {
    public ValidationResult validate(PaymentRequest request) {
      return request.amount() <= 0 ? ValidationResult.fail("amount") : ValidationResult.passed();
    }
  }
  ...
  public static final class FraudValidator implements Validator {
    public ValidationResult validate(PaymentRequest request) {
      return request.amount() > 20000
          ? ValidationResult.fail("fraud-review")
          : ValidationResult.passed();
    }
  }

  public interface PaymentStrategy {
    String execute(PaymentRequest request, PaymentGateway gateway);
  }

  public static final class CardStrategy implements PaymentStrategy {
    public String execute(PaymentRequest request, PaymentGateway gateway) {
      return gateway.charge("CARD", request.amount());
    }
  }

  public static final class UpiStrategy implements PaymentStrategy {
    public String execute(PaymentRequest request, PaymentGateway gateway) {
      return gateway.charge("UPI", request.amount());
    }
  }

  public interface PaymentGateway {
    String charge(String channel, int amount);
  }

  public static final class StripeGateway implements PaymentGateway {
    public String charge(String channel, int amount) {
      return "stripe-" + channel + "-" + amount;
    }
  }

  public static final class AdyenGateway implements PaymentGateway {
    public String charge(String channel, int amount) {
      return "adyen-" + channel + "-" + amount;
    }
  }

  public static final class LegacyGatewayApi {
    String send(String flow, int amount) {
      return "legacy-" + flow + "-" + amount;
    }
  }
  ...
  public static final class LegacyGatewayAdapter implements PaymentGateway {
    ...
    public String charge(String channel, int amount) {
      return legacy.send(channel, amount);
    }
  }
  ...
  public static final class CoreProcessor implements Processor {
    ...
    public CoreProcessor(PaymentStrategy strategy, PaymentGateway gateway) {
      this.strategy = strategy;
      this.gateway = gateway;
    }

    public String process(PaymentRequest request) {
      return strategy.execute(request, gateway);
    }
  }

  public abstract static class ProcessorDecorator implements Processor {
    protected final Processor delegate;
    protected final List<String> auditTrail;

    protected ProcessorDecorator(Processor delegate, List<String> auditTrail) {
  ...
  public static final class LoggingDecorator extends ProcessorDecorator {
    public LoggingDecorator(Processor delegate, List<String> auditTrail) {
      super(delegate, auditTrail);
    }
  ...
  public static final class MetricsDecorator extends ProcessorDecorator {
    public MetricsDecorator(Processor delegate, List<String> auditTrail) {
      super(delegate, auditTrail);
    }

    public String process(PaymentRequest request) {
      auditTrail.add("metric");
      return delegate.process(request);
    }
  }

  public static final class RetryDecorator extends ProcessorDecorator {
    public RetryDecorator(Processor delegate, List<String> auditTrail) {
      super(delegate, auditTrail);
    }

    public String process(PaymentRequest request) {
      auditTrail.add("retry-policy");
      return delegate.process(request);
    }
  }

  public interface PaymentObserver {
    void afterPayment(String reference, List<String> auditTrail);
  }

  public static final class NotificationObserver implements PaymentObserver {
    public void afterPayment(String reference, List<String> auditTrail) {
      auditTrail.add("notify:" + reference);
    }
  }

  public static final class AuditObserver implements PaymentObserver {
    public void afterPayment(String reference, List<String> auditTrail) {
      auditTrail.add("audit:" + reference);
    }
  }

  public static final class ReportingObserver implements PaymentObserver {
    public void afterPayment(String reference, List<String> auditTrail) {
      auditTrail.add("report:" + reference);
    }
  }
  ...
  public static final class Created implements PaymentState {
    public PaymentState next() {
  ...
  public static final class Authorized implements PaymentState {
    public PaymentState next() {
      return new Captured();
    }
  ...
  public static final class Captured implements PaymentState {
    public PaymentState next() {
  ...
  public static final class Completed implements PaymentState {
    public PaymentState next() {
      return this;
    }
  ...
  public static final class PaymentFacade {
    private final List<Validator> validators =
        List.of(new AuthenticationValidator(), new AmountValidator(), new FraudValidator());
    private final Map<String, PaymentStrategy> strategies =
        Map.of("CARD", new CardStrategy(), "UPI", new UpiStrategy());
    private final GatewayFactory gatewayFactory = new GatewayFactory();
    private final List<PaymentObserver> observers =
        List.of(new NotificationObserver(), new AuditObserver(), new ReportingObserver());
          ...
          new RetryDecorator(
              new MetricsDecorator(
                  new LoggingDecorator(
                      new CoreProcessor(
                          strategies.get(request.method()),
                          gatewayFactory.create(request.provider())),
                      trail),
                  trail),
              trail);
