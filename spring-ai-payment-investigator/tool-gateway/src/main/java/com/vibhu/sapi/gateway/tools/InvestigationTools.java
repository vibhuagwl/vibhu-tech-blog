...
public class InvestigationTools {
    ...
    public InvestigationTools(ToolGateway toolGateway, PaymentApplicationService paymentService,
    ...
    public PaymentView getPayment(String paymentId) {
        return toolGateway.invoke(UserContextHolder.get(),
                "getPayment",
                "{\"paymentId\":\"" + paymentId + "\"}",
    ...
    public String searchPaymentPolicy(String query) {
        return toolGateway.invoke(UserContextHolder.get(),
                ...
                () -> {
                    ...
                    return docs.stream()
                            .map(d -> d.getMetadata()
                                    .getOrDefault("source", "doc") + ": " + truncate(d.getText()))
