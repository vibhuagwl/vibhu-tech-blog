...
public class CounterService {
    ...
    public IncrementCounterResponse increment(
        ...
        ShardKey shardKey = counterStore.chooseShard(resourceId, stableShardHint(action, userId, request, idempotencyKey));
        counterStore.increment(shardKey, delta);

        CounterDeltaEvent event = new CounterDeltaEvent(
    ...
    public CounterValueResponse get(String resourceId) {
        validateResourceId(resourceId);
        return new CounterValueResponse(resourceId, counterStore.sum(resourceId), counterStore.shardMap(resourceId), SHARD_SUM);
    }
