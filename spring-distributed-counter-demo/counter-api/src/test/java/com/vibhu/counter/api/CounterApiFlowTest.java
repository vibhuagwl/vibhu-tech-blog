...
class CounterApiFlowTest {
    ...
    void likesAreIdempotentAndShardsAreReadable() {
        ...
        ResponseEntity<IncrementCounterResponse> aliceLike = restTemplate.exchange(
                "/api/v1/counters/{resourceId}/increment",
                HttpMethod.POST,
                new HttpEntity<>(new IncrementCounterRequest(1L, "alice-like-post-1", CounterAction.LIKE), aliceHeaders),
        ...
        ResponseEntity<IncrementCounterResponse> aliceRetry = restTemplate.exchange(
                "/api/v1/counters/{resourceId}/increment",
                HttpMethod.POST,
                new HttpEntity<>(new IncrementCounterRequest(1L, "alice-like-post-1", CounterAction.LIKE), aliceHeaders),
                IncrementCounterResponse.class,
        ...
        ResponseEntity<IncrementCounterResponse> bobLike = restTemplate.exchange(
                "/api/v1/counters/{resourceId}/increment",
                HttpMethod.POST,
                new HttpEntity<>(new IncrementCounterRequest(1L, "bob-like-post-1", CounterAction.LIKE), bobHeaders),
                IncrementCounterResponse.class,
                "post-1"
        );
        ...
        ResponseEntity<CounterValueResponse> value = restTemplate.getForEntity(
                "/api/v1/counters/{resourceId}",
                CounterValueResponse.class,
                "post-1"
        );
        ...
        ResponseEntity<ShardBreakdownResponse> shards = restTemplate.getForEntity(
                "/api/v1/counters/{resourceId}/shards",
                ShardBreakdownResponse.class,
                "post-1"
        );
        ...
        assertThat(shards.getBody().shards()).anySatisfy(shard -> assertThat(shard.value()).isGreaterThan(0));
    }
