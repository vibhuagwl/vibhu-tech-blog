...
public class ComparatorLab {
    ...
    static void multiLevelSort() {
        ...
        Comparator<Employee> byDeptThenId = Comparator.comparing(Employee::dept)
    ...
    static void nullsLast() {
        System.out.println("\n--- nullsLast on dept ---");
        Comparator<Employee> cmp = Comparator.comparing(Employee::dept, Comparator.nullsLast(String::compareTo))
                .thenComparingInt(Employee::id);
